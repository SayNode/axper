import 'package:casper_sdk/casper_dart_sdk.dart';
import 'package:casper_sdk/contract-client/types.dart';
...
CLKey createRecipientAddress(CLValue recipient) {
  if (recipient is CLPublicKey ||
    ...
    if (recipient.clType().toString() == PUBLIC_KEY_ID) {
      print('Hash');
      print(CLAccountHash((recipient as CLPublicKey).toAccountHash()).data);
      return CLKey(
