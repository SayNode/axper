...
class Ed25519 extends AsymmetricKey {
  ...
  static String accountHexStr(Uint8List publicKey) {
    return '01' + base16Encode(publicKey);
  }
...
class Secp256K1 extends AsymmetricKey {
  ...
  static Secp256K1 newKey() {
    ...
    return Secp256K1(base16Decode(publicKeyHex), base16Decode(privateKeyHex));
  }
  ...
  static String accountHexStr(Uint8List publickKey) {
    return '02' + base16Encode(publickKey);
  }
  ...
  static Uint8List parsePrivateKeyFile(String priv) {
    return Secp256K1.parsePrivateKey(Secp256K1.readBase64File(priv));
  }
  ...
  static Uint8List readBase64File(String priv) {
    return Secp256K1.readBase64WithPEM(priv);
  }
  ...
  static AsymmetricKey loadKeyPairFromPrivateFile(String privateKeyString) {
    var ec = elliptic.getSecp256k1();
    var privateKey = Secp256K1.parsePrivateKeyFile(privateKeyString);
    var publicKey =
        elliptic.PrivateKey.fromHex(ec, base16Encode(privateKey)).publicKey;
    return Secp256K1.parseKeyPair(
        Uint8List.fromList(base16Decode(publicKey.toCompressedHex())),
        privateKey,
        'raw');
  }
